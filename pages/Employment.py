...
st.set_page_config(page_title="Employment", layout="wide", initial_sidebar_state="collapsed")
...
st.title("All Employees: Total Nonfarm")
...
try:
    latest_date = get_latest_date("PAYEMS")
    data = fetch_data("PAYEMS", start_date=st.session_state.start_date, frequency=freq_code, units=units_code)
    ...
    st.error(f"Error fetching Employment data: {e}")
